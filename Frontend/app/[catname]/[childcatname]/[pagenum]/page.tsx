...
const metadatas = [
  ...
  {key : "bath-spouts", title : "Explore Bath Spouts in Kolkata | Premium Bathware", description : "Discover wall-mount and deck-mount bath spouts and fillers in Kolkata at Premium Bathware. Get a quote today!"},
